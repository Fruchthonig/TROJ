...
(cl:defclass <ServoConfigArray> (roslisp-msg-protocol:ros-message)
  ((servos
    :reader servos
    :initarg :servos
    :type (cl:vector troj_controller-msg:ServoConfig)
   :initform (cl:make-array 0 :element-type 'troj_controller-msg:ServoConfig :initial-element (cl:make-instance 'troj_controller-msg:ServoConfig))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <ServoConfigArray>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ServoConfigArray)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name troj_controller-msg:<ServoConfigArray> is deprecated: use troj_controller-msg:ServoConfigArray instead.")))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <ServoConfigArray>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'servos)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'troj_controller-msg:ServoConfig))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<ServoConfigArray>)))
  ...
  "troj_controller/ServoConfigArray")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'ServoConfigArray)))
  "Returns string type for a message object of type 'ServoConfigArray"
  "troj_controller/ServoConfigArray")
