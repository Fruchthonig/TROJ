...
(cl:defmethod cl:initialize-instance :after ((m <Position>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Position)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name troj_controller-msg:<Position> is deprecated: use troj_controller-msg:Position instead.")))
...
(cl:defmethod position-val ((m <Position>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader troj_controller-msg:position-val is deprecated.  Use troj_controller-msg:position instead.")
  (position m))
