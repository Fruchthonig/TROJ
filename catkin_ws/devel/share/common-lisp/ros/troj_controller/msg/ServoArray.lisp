...
(cl:defclass <ServoArray> (roslisp-msg-protocol:ros-message)
  ((servos
    :reader servos
    :initarg :servos
    :type (cl:vector troj_controller-msg:Servo)
   :initform (cl:make-array 0 :element-type 'troj_controller-msg:Servo :initial-element (cl:make-instance 'troj_controller-msg:Servo))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <ServoArray>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ServoArray)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name troj_controller-msg:<ServoArray> is deprecated: use troj_controller-msg:ServoArray instead.")))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <ServoArray>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'servos)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'troj_controller-msg:Servo))
