...
"""autogenerated by genpy from sixpack_controller/PositionArray.msg. Do not edit."""
import sys
...
class PositionArray(genpy.Message):
  ...
  _type = "sixpack_controller/PositionArray"
...
"""
  __slots__ = ['servos']
  _slot_types = ['sixpack_controller/Position[]']
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      for val1 in self.servos:
        _x = val1
        buff.write(_struct_2h.pack(_x.servo, _x.position))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = sixpack_controller.msg.Position()
        _x = val1
        start = end
        end += 4
        (_x.servo, _x.position,) = _struct_2h.unpack(str[start:end])
