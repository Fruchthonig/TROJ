...
(cl:defmethod cl:initialize-instance :after ((m <Position>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Position)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name sixpack_controller-msg:<Position> is deprecated: use sixpack_controller-msg:Position instead.")))
...
(cl:defmethod position-val ((m <Position>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sixpack_controller-msg:position-val is deprecated.  Use sixpack_controller-msg:position instead.")
  (position m))
