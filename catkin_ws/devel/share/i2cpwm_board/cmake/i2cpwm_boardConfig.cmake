...
if("TRUE" STREQUAL "TRUE")
  set(i2cpwm_board_SOURCE_PREFIX /home/tobias/catkin_ws/src/ros-i2cpwmboard)
  set(i2cpwm_board_DEVEL_PREFIX /home/tobias/catkin_ws/devel)
  ...
  set(i2cpwm_board_INSTALL_PREFIX /home/tobias/catkin_ws/install)
...
if(NOT "/home/tobias/catkin_ws/devel/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'i2cpwm_board' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/tobias/catkin_ws/src/ros-i2cpwmboard/${idir}'.  Ask the maintainer 'bradanlane <locoro@bradanlane.com>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/tobias/catkin_ws/devel/lib;/opt/ros/indigo/lib)
