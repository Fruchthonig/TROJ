...
(cl:defmethod cl:initialize-instance :after ((m <ServoConfig>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ServoConfig)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name troj_controller-msg:<ServoConfig> is deprecated: use troj_controller-msg:ServoConfig instead.")))

(cl:ensure-generic-function 'servo-val :lambda-list '(m))
(cl:defmethod servo-val ((m <ServoConfig>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader troj_controller-msg:servo-val is deprecated.  Use troj_controller-msg:servo instead.")
  (servo m))

(cl:ensure-generic-function 'center-val :lambda-list '(m))
(cl:defmethod center-val ((m <ServoConfig>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader troj_controller-msg:center-val is deprecated.  Use troj_controller-msg:center instead.")
  (center m))

(cl:ensure-generic-function 'range-val :lambda-list '(m))
(cl:defmethod range-val ((m <ServoConfig>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader troj_controller-msg:range-val is deprecated.  Use troj_controller-msg:range instead.")
  (range m))

(cl:ensure-generic-function 'direction-val :lambda-list '(m))
(cl:defmethod direction-val ((m <ServoConfig>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader troj_controller-msg:direction-val is deprecated.  Use troj_controller-msg:direction instead.")
  (direction m))
