...
(cl:defclass <PositionArray> (roslisp-msg-protocol:ros-message)
  ((servos
    :reader servos
    :initarg :servos
    :type (cl:vector troj_controller-msg:Position)
   :initform (cl:make-array 0 :element-type 'troj_controller-msg:Position :initial-element (cl:make-instance 'troj_controller-msg:Position))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <PositionArray>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'PositionArray)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name troj_controller-msg:<PositionArray> is deprecated: use troj_controller-msg:PositionArray instead.")))

(cl:ensure-generic-function 'servos-val :lambda-list '(m))
(cl:defmethod servos-val ((m <PositionArray>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader troj_controller-msg:servos-val is deprecated.  Use troj_controller-msg:servos instead.")
  (servos m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <PositionArray>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'servos)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'troj_controller-msg:Position))
