...
(cl:defclass <PositionArray> (roslisp-msg-protocol:ros-message)
  ((servos
    :reader servos
    :initarg :servos
    :type (cl:vector sixpack_controller-msg:Position)
   :initform (cl:make-array 0 :element-type 'sixpack_controller-msg:Position :initial-element (cl:make-instance 'sixpack_controller-msg:Position))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <PositionArray>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'PositionArray)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name sixpack_controller-msg:<PositionArray> is deprecated: use sixpack_controller-msg:PositionArray instead.")))

(cl:ensure-generic-function 'servos-val :lambda-list '(m))
(cl:defmethod servos-val ((m <PositionArray>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sixpack_controller-msg:servos-val is deprecated.  Use sixpack_controller-msg:servos instead.")
  (servos m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <PositionArray>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'servos)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'sixpack_controller-msg:Position))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<PositionArray>)))
  ...
  "sixpack_controller/PositionArray")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'PositionArray)))
  "Returns string type for a message object of type 'PositionArray"
  "sixpack_controller/PositionArray")
