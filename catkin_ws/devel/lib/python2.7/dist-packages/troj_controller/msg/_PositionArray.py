...
"""autogenerated by genpy from troj_controller/PositionArray.msg. Do not edit."""
import sys
...
class PositionArray(genpy.Message):
  ...
  _type = "troj_controller/PositionArray"
...
"""
  __slots__ = ['servos']
  _slot_types = ['troj_controller/Position[]']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = troj_controller.msg.Position()
        _x = val1
        start = end
        end += 4
