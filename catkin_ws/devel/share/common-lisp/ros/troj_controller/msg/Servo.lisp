...
(cl:defmethod cl:initialize-instance :after ((m <Servo>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Servo)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name troj_controller-msg:<Servo> is deprecated: use troj_controller-msg:Servo instead.")))
...
(cl:defmethod value-val ((m <Servo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader troj_controller-msg:value-val is deprecated.  Use troj_controller-msg:value instead.")
  (value m))
