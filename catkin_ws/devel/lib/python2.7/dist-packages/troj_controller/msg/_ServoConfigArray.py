...
"""autogenerated by genpy from troj_controller/ServoConfigArray.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct

import troj_controller.msg

class ServoConfigArray(genpy.Message):
  _md5sum = "8f9c43713b493f265aec1e926dd292b8"
  _type = "troj_controller/ServoConfigArray"
...
"""
  __slots__ = ['servos']
  _slot_types = ['troj_controller/ServoConfig[]']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = troj_controller.msg.ServoConfig()
        _x = val1
        start = end
        end += 8
