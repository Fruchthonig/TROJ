...
(cl:defclass <ServoConfigArray> (roslisp-msg-protocol:ros-message)
  ((servos
    :reader servos
    :initarg :servos
    :type (cl:vector sixpack_controller-msg:ServoConfig)
   :initform (cl:make-array 0 :element-type 'sixpack_controller-msg:ServoConfig :initial-element (cl:make-instance 'sixpack_controller-msg:ServoConfig))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <ServoConfigArray>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ServoConfigArray)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name sixpack_controller-msg:<ServoConfigArray> is deprecated: use sixpack_controller-msg:ServoConfigArray instead.")))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <ServoConfigArray>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'servos)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'sixpack_controller-msg:ServoConfig))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<ServoConfigArray>)))
  ...
  "sixpack_controller/ServoConfigArray")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'ServoConfigArray)))
  "Returns string type for a message object of type 'ServoConfigArray"
  "sixpack_controller/ServoConfigArray")
